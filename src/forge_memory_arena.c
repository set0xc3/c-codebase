...
void arena_clear(MemoryArena *arena) { arena->pos = 0; }

u64 arena_get_pos(MemoryArena *arena) { return arena->pos; }
...
void arena_temp_end(MemoryArenaTemp temp) { temp.arena->pos = temp.pos; }
