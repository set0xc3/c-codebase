...
char *str8_c(const String8 string) {
...
void str8_realloc(String8 *result, const uint64_t new_size) {
...
void str8_free(String8 *string) { free(string); }
...
bool str8_eq(const String8 left, const String8 right) {
