...
EXPORT_LIB void input_mouse_position_callback(V2F position);
EXPORT_LIB void input_scroll_callback(V2F delta);
...
EXPORT_LIB V2F  input_mouse_position_get(void);
EXPORT_LIB V2F  input_mouse_wheel_get(void);
